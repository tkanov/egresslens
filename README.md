...
- **[sample_app/README](sample_app/README.md)**  
...
- **[backend/README](backend/README.md)**  
  FastAPI backend for uploading, aggregating, and serving reports generated by the CLI.

- **[frontend/README](frontend/README.md)**  
  React + TypeScript web UI for exploring egress analysis reports.
